...
export const CartProductsCards = ({ img }) => (
	<div className="noz-cart-products mt-4 border-bottom mb-3 pb-3">
		<div className="d-flex justify-content-between">
			<div className="noz-cart-product-details d-flex align-items-center">
				<input type="checkbox" name="" id="" />
				<img src={img} className="img-fluid" alt="" />
				<div className="noz-cart-product-details-body">
					...
					<span className="text-success noz-fs-11 normal-text">
						In stock
					</span>
					<br />
					<span className="text-muted noz-fs-11 normal-text">
						Eligible for FREE Shipping
					</span>
					<br />
					<img src={noz_fullfill} className="img-fluid" alt="noz-fullfill" />
					<br />
					...
					<span className="noz-fs-11 normal-text">
						<b>Flavor</b>: Chocolate
					</span>
					<br />
					<span className="noz-fs-11 normal-text">
						<b>Size</b>: 1 kg (Pack of 1)
					</span>
					<br />
			...
			<div className="noz-cart-product-price">
...
export const SponsoredProductsCard = ({ img }) => (
	<div className="noz-sponsor-product d-flex pb-3">
		<div className="">
			<img src={img} className="img-fluid" alt="" style={{width:"100px"}} />
		</div>
		<div className="noz-sponsor-product-details px-3">
			<Link to="" className="noz-link">
			...
			<Starsvgicon />
			<br />
			<span className="normal-text noz-fs-13 text-danger">
				$10.00
			</span>
			<br />
			<button className="noz-btn btn-sm medium-text noz-fs-11 noz-btn-primary shadow-sm py-2" style={{backgroundColor:"#83b77d",border:"none",borderRadius:"10px"}}>
				Proceed to Buy
			</button>
		</div>
	</div>
