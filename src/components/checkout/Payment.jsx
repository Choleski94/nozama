               ...
               <div className="px-5 py-3 border mx-5 mt-3 rounded">
                    <div className="d-flex">
                        ...
                        <div className="px-3">
                            ...
                            <span className="normal-text noz-fs-13">Scan & Pay using Nozama app. Cash, UPI ,Cards also accepted.Know more.</span>
                        </div>
                    </div>
                    ...
                    <div className="d-flex align-items-center mt-3">
                        ...
                        <div className="px-3">
                            ...
                            <span className="normal-text noz-fs-12">You can save your cards as per new RBI guidelines.Learn More</span>
                        </div>
                    </div>
               </div>
            </div>
