const SearchTab = () => {
	return (
		<div className="nozama-search-tab">
			<div className="d-flex">
				<select className="nozama-select-option px-3 py-2" title="Search in">
					<option selected="selected" value="search-alias=aps">All Categories</option>
					<option value="search-alias=alexa-skills">Alexa Skills</option>
					<option value="search-alias=nozama-devices">Nozama Devices</option>
					<option value="search-alias=fashion">Nozama Fashion</option>
					<option value="search-alias=nowstore">Nozama Fresh</option>
					<option value="search-alias=nozama-pharmacy">Nozama Pharmacy</option>
				...
				<input type="search" className="nozama-search-input px-2" placeholder="Search Nozama" />
				<button type="submit" className="px-3 nozama-search-button">
