...
export const AccountHome = () => (
	<div className="row">
		<AccountCards img={Box} title='Your Orders' desc='Track, return, or buy things again' link='/account/orders' />
		...
		<AccountCards img={Location} title='Your Addresses' desc='Edit addresses for orders and gifts' link='/account/address' />
		<AccountCards img={Payment} title='Payment options' desc='Edit or add payment methods' link='' />
		<AccountCards img={Amz_Payment} title='Nozama Pay balance' desc='Add money to your balance' link='' />
...
const AccountCards = ({ img, title, desc, link }) => (
	<Link to={link} className="col-sm-4 mb-4">
		<div className="noz-account-card border p-3">
