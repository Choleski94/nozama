...
const Home = () => {
	...
	return (
		<>
			<Navbar />
				<section className="nozama-banner" style={{height:"230px"}}>
					<img src={banner} alt="noz-banner-img" className="img-fluid" />
				</section>
				<main className="container-fluid product-card-main">
					<div className="row">
						<ProductCard card_title='Upgrade your home | Nozama Brands & more' p_img1={img1} p_img2={img2} p_img3={img3} p_img4={img4} p1_title='upto 50% | Home applances' />
