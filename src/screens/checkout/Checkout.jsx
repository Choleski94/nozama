...
const Checkout = () => {
	...
	return (
		<>
			<div className="noz-checkout-nav d-flex justify-content-around pt-4">
			...
			<div className="noz-checkout mx-auto">
				<div className="row">
					<div className="col-sm-9">
						<AddressSection />
						<PaymentCard />
						{/* <ItemsSection /> */}
						<div className="noz-checkout-footer my-5">
							<p className="noz-fs-11 text-muted normal-text">
